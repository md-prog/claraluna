...
class StoresAbiti extends PageContainer {
    ...
    render() {
        ...
        return (
            <div className="o-stores">
                <i className="o-ico o-ico--lens o-stores__lens" />
                <Sidebar
...
export default connect(mapStateToProps, mapDispatchToProps)(StoresAbiti);


/** WEBPACK FOOTER **
 ** ./containers/PageStoreLocator/page-StoresAbiti.jsx
 **/